                                                    ...
                                                    <div class="mega-menu-area clearfix">
                                                        <div class="mega-menu-link mega-menu-link-4  f-left">
                                                            <ul class="single-mega-item">
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="elements-header-1-sticky.html">header-1-sticky</a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="elements-header-2-sticky.html">header-2-sticky</a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                            ...
                                                            <ul class="single-mega-item">
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="elements-product-tab-1.html">product-tab-1</a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="elements-product-tab-2.html">product-tab-2</a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="elements-single-product.html">single-product</a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="elements-sidebar-left.html">sidebar-left</a>
                                                                </li>
                                                                <li>
                                                                    <a
                                                                        href="elements-sidebar-right.html">sidebar-right</a>
                                                                </li>
                                                            </ul>
                                                            <ul class="single-mega-item">
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="elements-section-title.html">section-title</a>
                                                                </li>
                                                                <li>
                                                ...
                                                <li class="mega-parent"><a href="shop.html">Products</a>
                                                    <div class="mega-menu-area clearfix">
                                                        ...
                                                        <div class="mega-menu-photo f-left">
                                                            <a href="#">
                                                                <img src="resources/js/img/mega-menu/1.jpg"
                                                                    alt="mega menu image">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mega-menu-area mega-menu-area-2 clearfix">
                                                        <div class="mega-menu-link mega-menu-link-2  f-left">
                                                            <ul class="single-mega-item">
                                                                ...
                                                                <li>
                                                                    <a href="single-product-left-sidebar.html">Single
                                                                        Product Left Sidebar</a>
                                                                </li>
                                                                <li>
                                                                    <a href="single-product-no-sidebar.html">Single
                                                    ...
                                                    <ul class="dropdwn">
                                                        <li><a href="blog-left-sidebar.html">Dropdown Repeat</a>
                                                            <ul class="dropdwn-repeat">
                                                                ...
                                                                <li>
                                                                    <a href="blog-2-left-sidebar.html">Blog 2 Left
                                                                        Sidebar</a>
                                                                </li>
                                                                <li>
                                                                    <a href="blog-2-right-sidebar.html">Blog 2 Right
                                                                        Sidebar</a>
                                                                </li>
                                                                <li>
                                    ...
                                    <div class="by-brand-product">
                                        <div class="active-by-brand slick-arrow-2">
                                            <div class="brand-item">
                                                <div class="single-brand-product">
                                                    <a href="single-product.html"><img
                                                            src="resources/js/img/product/5.jpg" alt=""></a>
                                            ...
                                            <div class="brand-item">
                                                <div class="single-brand-product">
                                                    <a href="single-product.html"><img
                                                            src="resources/js/img/product/6.jpg" alt=""></a>
                                                    <h3 class="brand-title text-gray">
                                                        <a href="#">Brand name</a>
                                                    </h3>
                                                </div>
                                            ...
                                            <div class="brand-item">
                                                <div class="single-brand-product">
                                                    <a href="single-product.html"><img
                                                            src="resources/js/img/product/7.jpg" alt=""></a>
                                                    <h3 class="brand-title text-gray">
                                                        <a href="#">Brand name</a>
                                                    </h3>
                                                </div>
                                            ...
                                            <div class="brand-item">
                                                <div class="single-brand-product">
                                                    <a href="single-product.html"><img
                                                            src="resources/js/img/product/8.jpg" alt=""></a>
                                                    <h3 class="brand-title text-gray">
                                                        <a href="#">Brand name</a>
                                                    </h3>
                                                </div>
                                ...
                                <div class="col-lg-8">
                                    <div class="up-comming-pro gray-bg clearfix">
                                        ...
                                        <div class="up-comming-pro-info f-left">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elitest, sed do
                                                eiusmod
                                                tempor incididunt ut labore et dolores top magna aliqua. Ut enim ad
                                                minim
                                                veniam, quis nostrud exer citation ullamco laboris nisi ut aliquip ex ea
                                                commodo consequat. laborum. </p>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div id="popular-product" class="tab-pane active show" role="tabpanel">
                                            <div class="row">
                                                <!-- product-item start -->
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="blog">
                                        <div class="active-blog">
                                            <div class="blog-item">
                                                <img src="resources/js/img/blog/1.jpg" alt="">
                                                <!-- <div class="blog-desc">
                                        ...
                                        <div class="single-footer footer-about">
                                            ...
                                            <div class="footer-brief">
                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                    industry. Lorem Ipsum has been the subas industry's standard dummy
                                                    text ever since the 1500s,</p>
                                                <p>When an unknown printer took a galley of type and If you are going to
                                                    use a passage of Lorem Ipsum scrambled it to make.</p>
                                            </div>
                                            <ul class="footer-social">
                                                <li>
                                    ...
                                    <div class="col-xl-2 d-block d-xl-block d-lg-none d-md-none">
                                        <div class="single-footer">
                                            ...
                                            <ul class="footer-menu">
                                                ...
                                                <li>
                                                    <a href="#"><i
                                                            class="zmdi zmdi-circle"></i><span>Suppliers</span></a>
                                                </li>
                                                <li>
                                ...
                                <div class="modal-product clearfix">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="quick-desc">
                                            ...
                                            nec est tristique auctor. Donec non est at libero.
                                        </div>
